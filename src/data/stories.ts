...
/**
 * Sample feed. People, headlines and numbers are fictional; the clips are public test videos (test-videos.co.uk)
 * and covers (picsum.photos) stand in for real story footage.
 */
...
const cover = (id: number) => `https://picsum.photos/id/${id}/800/450`;

export const SAMPLE_STORIES: Story[] = [
  {
    id: 's1',
    author: { id: 'u1', name: 'Amit Saxena' },
    category: 'Local',
